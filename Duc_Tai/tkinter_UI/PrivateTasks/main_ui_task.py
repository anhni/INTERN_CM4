...
class Main_UI:
    ...
    def init_fun(self,data):
        ...
        self.logo = PhotoImage(file="bku.png")
        self.on = PhotoImage(file="button_on.png")
        self.off = PhotoImage(file="button_off.png")
        ...
        self.labelDistance = tk.Label(text="Distance",
                                ...
                                # bg = "#000",
                                font="Helvetica 60 bold")
        self.labelDistance.place(x=0, y=600, width=screen_width / 3, height=100)
